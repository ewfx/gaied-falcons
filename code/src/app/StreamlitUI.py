...
if 'request_type_config' not in st.session_state:
    st.session_state.request_type_config = {
        "Adjustment": ["date", "account", "loan_id"],
        "AU Transfer": ["source_account", "destination_account", "transfer_amount", "transfer_date", "amount", "date"],
        "Closing Notice": ["Reallocation Fees","Amendment Fees", "Reaalocation Principal","deal_name", "closing_date", "contact_person", "final_amount"],
        "Commitment Change": ["Cashless Rool", "Decrease", "Increase""date", "old_amount", "new_amount", "change_reason"],
        "Fee Payment": ["Ongoing Fee","Letter of Credit Fee","invoice_number", "payment_amount", "due_date", "payment_method"],
        "Money Movement Inbound": ["Principal", "Interest","Principal + Interest","Principal + Interest + Fee","sender", "amount", "receiving_account", "expected_date", "name"],
        "Money Movement Outbound": ["Timebound","Foreign Currency","recipient", "amount", "sending_account", "transfer_date", "name"]
    }
